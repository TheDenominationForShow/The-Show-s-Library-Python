...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=_b('\n\x16ShowLibInterface.proto\x12\x10ShowLibInterface\"G\n\x0cRCHashRecord\x12\x0c\n\x04hash\x18\x01 \x01(\t\x12\x0c\n\x04name\x18\x02 \x01(\t\x12\x0c\n\x04size\x18\x03 \x01(\t\x12\r\n\x05mtime\x18\x04 \x01(\t\"d\n\x06Result\x12\x30\n\x03RET\x18\x01 \x01(\x0e\x32#.ShowLibInterface.Result.ResultType\"(\n\nResultType\x12\x0b\n\x07SUCCESS\x10\x00\x12\r\n\tHAS_EXIST\x10\x01\x32[\n\x07Greeter\x12P\n\x12InsertRCHashRecord\x12\x1e.ShowLibInterface.RCHashRecord\x1a\x18.ShowLibInterface.Result\"\x00\x62\x06proto3')
)
...
_RESULT_RESULTTYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='HAS_EXIST', index=1, number=1,
      serialized_options=None,
      type=None),
  ],
